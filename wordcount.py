...
text=''' Society called him Handsome Signoles. His name was Viscount Gontran-Joseph de Signoles.
...
sorted_countwords=sorted(countwords.items(), key=lambda x: x[1], reverse=True)
print(countwords.keys())
print(countwords.values())
print(countwords)
pprint.pprint(sorted_countwords)
